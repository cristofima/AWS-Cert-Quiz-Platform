    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight max-w-4xl">
            Master Your <span className="text-primary">AWS Certification</span>{" "}
            with Real Exam Practice
          </h1>

          <p className="text-xl text-muted-foreground max-w-2xl">
            Practice with 1,200+ quality exam questions designed to help you ace
      ...
      <section className="container mx-auto px-4 py-20 bg-muted/50 rounded-lg">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Practice questions for all three AWS Associate-level certifications
          </p>
        </div>
